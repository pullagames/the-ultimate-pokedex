<template>
  <div class="flex justify-between items-center dark:bg-gray-800 bg-white border-b border-gray-200 dark:border-gray-700 p-4">
    ...
    <div>
      <div class="flex items-center space-x-4">
        <div class="font-semibold text-gray-800 dark:text-gray-400">
