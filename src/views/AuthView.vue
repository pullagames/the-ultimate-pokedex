          ...
          <div class="flex flex-col justify-between h-full lg:h-auto lg:justify-start lg:space-y-8">
            <div class="flex justify-between">
              <title-subtitle-molecule
                ...
                :subtitle="currentForm === 'login' ? 'Connectez vous à votre compte d\'entraîneur pokémon.' : 'Configurons votre compte d\'entraineur pokémon ensemble.'"
              />
              <transition name="fade" mode="out-in">
                <icon-atom key="dark" v-if="isDarkMode === 'true'" :action="() => setDarkMode('false')">
                  <template>
                ...
                <icon-atom key="light" v-if="isDarkMode === 'false'" :action="() => setDarkMode('true')">
                  <template>
                    <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
